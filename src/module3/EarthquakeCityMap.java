...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
    	...
    	Iterator<PointFeature> pointFeatureIterator = earthquakes.iterator();
    	while(pointFeatureIterator.hasNext())
    	{
    		PointFeature f = pointFeatureIterator.next();
    		de.fhpotsdam.unfolding.geo.Location l = f.getLocation();
